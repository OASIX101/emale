    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(max_length=100)),
                ('time_added', models.TimeField(auto_now_add=True, null=True)),
                ('meal1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_1', to='home_app.vendormeal')),
                ('meal2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_2', to='home_app.vendormeal')),
                ('meal3', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_3', to='home_app.vendormeal')),
            ],
        ),
        migrations.CreateModel(
            name='ComUserChoice',
